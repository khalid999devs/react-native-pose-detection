...
<p align="center">
  <img alt="Live camera with the skeleton tracking a person" src="./ss/live-camera.png" width="30%" />
  <img alt="Studio screen painting an uploaded video" src="./ss/studio-video.png" width="30%" />
