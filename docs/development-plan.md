...
- [x] Engine bindings identical to Android, verified by 69 XCTests over the same behavior the
...
- [x] Unit tests on both native sides: trigger evaluator, condition evaluator, geometry, wire
      encoding, driven by shared fixtures. 65 JUnit tests and 69 XCTests, both in CI
